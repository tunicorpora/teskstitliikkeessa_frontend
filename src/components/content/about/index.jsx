...
export default () => (
  <div className={styles.wrapper}>
    <article className={styles.content}>
      <p>
        TeLi-tietokanta on suunniteltu TeLi-projektille. Tähän tietokantaan on koottu bibliografisia
        tietoja suomalaisten ja venäläisten naiskirjailijoiden kirjoittamista teoksista ja niiden
        käännöksistä ja muusta vastaanotosta Venäjällä ja Suomessa.{' '}
      </p>
      ...
      <footer className={styles.imageContainer}>
        <img src={Linder} alt="Marie Linder" />
        <img src={Kollontai} alt="Alexandra Kollontai" />
        <img src={Gan} alt="Helena Gan" />
        <img src={Oksanen} alt="Sofi Oksanen" />
      </footer>
    </article>
  </div>
);
